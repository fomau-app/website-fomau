      ...
      >
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-white text-gray-900 font-medium w-full sm:w-52 py-4 rounded-2xl text-base flex items-center justify-center gap-3 hover:scale-105 transition-all"
          >
