      ...
      >
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="glass-card text-white font-medium w-full sm:w-52 py-4 rounded-2xl text-base flex items-center justify-center gap-3 hover:border-brand/40 hover:scale-105 transition-all"
          >
