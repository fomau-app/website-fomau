...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-6 pt-24">
      ...
      <div ref={orb2} className="orb w-[500px] h-[500px] bg-brand-light/10 bottom-[-100px] left-[-100px]" />
      ...
      <motion.div
        ...
        className="flex items-center gap-2 glass-card px-4 py-2 rounded-full mb-8 text-xs text-white/70"
      >
      ...
      >
        ...
        >
          <a
            ...
            className="shimmer-btn text-white font-semibold w-full sm:w-52 py-4 rounded-2xl text-base flex items-center justify-center gap-3 hover:scale-105 transition-transform hover:shadow-2xl hover:shadow-brand/40"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-white/10 border border-white/20 text-white font-medium w-full sm:w-52 py-4 rounded-2xl text-base flex items-center justify-center gap-3 hover:bg-white/15 hover:scale-105 transition-all"
          >
            <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
