      ...
      >
        ...
        >
          <a
            ...
            className="shimmer-btn text-white font-semibold px-8 py-4 rounded-2xl text-base flex items-center gap-3 hover:scale-105 transition-transform hover:shadow-2xl hover:shadow-brand/40"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="glass-card text-white font-medium px-8 py-4 rounded-2xl text-base flex items-center gap-3 hover:border-brand/40 hover:scale-105 transition-all"
          >
