      ...
      >
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-brand/20 border border-brand/40 text-white font-medium w-full sm:w-52 py-4 rounded-2xl text-base flex items-center justify-center gap-3 hover:bg-brand/30 hover:scale-105 transition-all"
          >
            <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
